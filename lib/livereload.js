...
(function() {
  var Server, defaultAlias, defaultExclusions, defaultExts, defaultPort, express, fs, http, merge, path, url, version, watchr, ws,
  ...
  defaultExts = ['html', 'css', 'js', 'png', 'gif', 'jpg', 'php', 'php5', 'py', 'rb', 'erb', 'jade'];
