...
(function() {
  var Server, defaultExclusions, defaultExts, defaultPort, fs, http, path, url, version, wait, watchr, ws,
      ...
      return watchr.watch({
        ...
        listener: function(eventName, filePath, fileCurrentStat, filePreviousStat) {
          ...
          for (_i = 0, _len = exts.length; _i < _len; _i++) {
            ...
            _results.push(console.log(filePath, "isChanged"));
          }
          return _results;
        },
        ignorePatterns: this.config.exclusions
      });
    };
